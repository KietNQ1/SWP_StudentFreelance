...
namespace StudentFreelance.Controllers
{
    public class SkillController : Controller
    {
        ...
        public SkillController(ISkillService skillService, ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> Index()
        {
            var skills = await _skillService.GetActiveSkillsWithCategoriesAsync();
            return View(skills); // Dùng ViewModel SkillWithCategoryViewModel
        }
        ...
        // POST: Skill/Delete/5 (Soft Delete)
        [HttpPost]
        public async Task<IActionResult> Delete(int id)
        {
            await _skillService.SoftDeleteAsync(id);
            return RedirectToAction(nameof(Index));
        }

        // POST: Skill/Unhide/5 (Hiện lại)
        [HttpPost]
        public async Task<IActionResult> Unhide(int id)
        {
            await _skillService.UnhideAsync(id);
            return RedirectToAction(nameof(Index));
        }
    }
}
